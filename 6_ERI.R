# Description: This file contains code for creating state and MSA level ERI
# values. The term ERI and MCC are used exchangeably. 
# Author: Wei Xu 
...
# function for calculating CBSA MCC
...
# function for calculating state MCC
